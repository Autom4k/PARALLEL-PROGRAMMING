...
*Рисунок 1 – Зависимость времени выполнения от количества потоков для матрицы 1200×1200*

![График 2 - Зависимость времени от размера матрицы (12 потоков)](graph2.png)

*Рисунок 2 – Зависимость времени выполнения от размера матрицы при использовании 12 потоков*
